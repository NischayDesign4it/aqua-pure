...
//     final double containerWidth = screenSize.width * 0.20;
...
//                   title: Text("Dashboard",style: TextStyle(color: TColors.textBlack, fontSize: 30),),
//                   centerTitle: false,
//                   toolbarHeight: 90,
//                   actions: [
//                     IconButton(
                  ...
                  children: [
                    AppBar(
                      ...
                      title: Text(
                        "Dashboard",
                        style:
                            TextStyle(color: TColors.textBlack, fontSize: 30),
                      ),
                      centerTitle: false,
                      toolbarHeight: 90,
                      actions: [
                          ...
                          Expanded(
                            child: Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: screenSize.maxWidth * 0.03),
