...
class SettingDesktop extends StatefulWidget {
  ...
  @override
  State<SettingDesktop> createState() => _SettingDesktopState();
}

class _SettingDesktopState extends State<SettingDesktop> {
  String selectedView = 'general';
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ExpansionTile(
                        ...
                        onExpansionChanged: (isExpanded) {
                          if (isExpanded) {
                            setState(() {
                              selectedView =
                                  'general'; // Show QGeneralContainer on expanding "General Process"
                            });
                          }
                        },
                        children: [
                          ExpansionTile(
                            ...
                            onExpansionChanged: (isExpanded) {
                              if (isExpanded) {
                                setState(() {
                                  selectedView =
                                      ''; // Reset view when instrument submenu is expanded
                                });
                              }
                            },
                            children: [
                              ListTile(
                                ...
                                onTap: () {
                                  setState(() {
                                    selectedView =
                                        'data1'; // Show QDataContainer for this submenu
                                  });
                                },
                              ),
                              ListTile(
                                ...
                                onTap: () {
                                  setState(() {
                                    selectedView =
                                        'data2'; // You can use different views for other submenus
                                  });
                                },
                              ),
                              ListTile(
                            ...
                            children: [
                              ListTile(
                                ...
                                onTap: () {
                                  setState(() {
                                    selectedView =
                                        'userManager'; // Optionally handle other views
                                  });
                                },
                              ),
                            ],
                      ...
                      if (selectedView == 'userManager') QpasswordReset()
                    ],
                  ),
                ),
              ),
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Container(
        decoration: BoxDecoration(
          borderRadius: BorderRadius.all(Radius.circular(4.0)),
          color: Colors.blue.withOpacity(0.3), // Customize your background color
        ),
        child: Padding(
